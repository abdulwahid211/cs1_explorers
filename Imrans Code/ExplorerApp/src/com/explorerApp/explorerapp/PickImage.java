...
public class PickImage extends Activity  {
	...
	//https://www.youtube.com/watch?v=cGt5t8ID_5Q --- For image gallery.
	...
	//String imageArray[] = {"ExplorerApp/res/drawable-mdpi/firstimage.png", "ExplorerApp/res/drawable-mdpi/secondimage.png", "ExplorerApp/res/drawable-mdpi/thirdimage.png"};

	//Each number in the array represents the images that are located in the res/drawable-mdpi folder.
	int imageArray[] = {/*2130837555, 2130837559, 2130837560*/  2130837569,  2130837563,  2130837559 };
				...
				Bitmap secondbit = BitmapFactory.decodeResource(getResources(), imageArray[1]);
				 ...
				 byteArray = stream.toByteArray();
				  ...
				  if (bmp.getWidth() == firstbit.getWidth() && bmp.getHeight() == firstbit.getHeight()) 
				  {
				        ...
				        {
				        	Intent intent = new Intent(v.getContext(), SecondImage.class);
							...
							intent.putExtra("secondImage", byteArray);
				  ...
				  if (bmp.getWidth() == secondbit.getWidth() && bmp.getHeight() == secondbit.getHeight()) 
				  {
				        ...
				        if (Arrays.equals(pixels1, pixels2)) 
				        {
				        	Intent intent = new Intent(v.getContext(), FirstImage.class);
							startActivityForResult (intent, 0);
							
							//This part is for being able to display the selected image on the next page.
							//Sending the users selected image to be displayed on the next page.
							intent.putExtra("firstImage", byteArray);
							startActivity(intent);
