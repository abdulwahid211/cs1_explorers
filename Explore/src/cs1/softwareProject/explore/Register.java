...
public class Register extends Activity implements OnClickListener{
	...
	private EditText user, pass,inter,bi;
 ...
 //   private static final String LOGIN_URL = "http://10.0.2.2/register.php";
    private static final String LOGIN_URL = "http://doc.gold.ac.uk/~ma301ma/IgorFile/register.php";
  //testing from a real server:
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		inter = (EditText)findViewById(R.id.interest);
		bi = (EditText)findViewById(R.id.bio);
	...
	class CreateUser extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
            ...
            String bio = bi.getText().toString();
            try {
                // Building Parameters
